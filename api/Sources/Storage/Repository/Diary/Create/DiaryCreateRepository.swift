...
struct DiaryCreateRepository {
    
    var db: Database
    
    func create(_ 日誌: Entity.Diary) async throws {
    ...
    private func 日誌モデル(_ 日誌: Entity.Diary) -> Diary {
        .init(
            UUID(),
            日誌.日付,
            日誌.天候,
